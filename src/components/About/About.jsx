...
const About = () => {
  return (
    <div className="gap-3 flex flex-col items-center border- border-2 border-black w-10/12 p-5 pb-10 my-10 lg:w-8/12 lg:p-10 lg:gap-10 lg:pb-16 lg:mb-20 xl:w-7/12 2xl:w-6/12">
      <h2 className="text-3xl lg:text-4xl font-medium font-estrato italic">
        About
      </h2>
