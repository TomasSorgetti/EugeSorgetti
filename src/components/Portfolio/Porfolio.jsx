    ...
    <div id="portfolio" className="pt-16">
      <section>
        ...
        <section className="bg-background1 flex flex-col items-center ">
          ...
          <article className="w-full mx-auto mb-20 px-6 flex flex-col gap-4">
            <a href="#time2talk" className="flex gap-2 pl-[5%] text-xl font-medium font-estrato italic">
              <p>01</p>
              <p>time2talk</p>
            </a>
            <a href="#aurabeauty" className="flex gap-2 pl-[15%] text-xl font-medium font-estrato italic">
              <p>02</p>
              <p>aura beauty</p>
            </a>
            <a href="#learning" className="flex gap-2 pl-[20%] text-xl font-medium font-estrato italic">
              <p>03</p>
              <p>learningspark</p>
            </a>
            <a href="#devportfolio" className="flex gap-2 pl-[30%] text-xl font-medium font-estrato italic">
              <p>04</p>
              <p>dev porfolio</p>
            </a>
            <a href="#design" className="flex gap-2 pl-[40%] text-xl font-medium font-estrato italic">
              <p>05</p>
              <div>
